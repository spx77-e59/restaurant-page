export default function () {
  ...
  const appetizers = [
    {
      ...
      description: "Crispy risotto balls filled with truffle-infused mushrooms and mozzarella, served with a tangy marinara sauce.",
      price: 12,
    },
    {
    ...
    },
    {
      ...
      description: "Diced sushi-grade tuna mixed with avocado and spicy mayo, served with crispy wonton chips.",
      price: 15,
    },
    {
      name: "Stuffed Bell Peppers",
      description: "Mini bell peppers stuffed with herbed cream cheese and wrapped in prosciutto, served with a spicy aioli.",
      price: 11,
    },
  ];
  ...
  const salads = [
    {
      ...
      description: "Mixed greens, roasted butternut squash, candied pecans, and goat cheese, topped with maple vinaigrette.",
      price: 14,
    },
    {
      name: "Caesar Salad",
      description: "Crisp romaine lettuce, homemade croutons, shaved parmesan, and Caesar dressing.",
      price: 12,
      addons: {
        "Grilled Chicken": 4,
      },
    },
    {
      ...
      description: "Quinoa, cucumbers, cherry tomatoes, olives, and feta cheese, tossed in lemon-oregano vinaigrette.",
      price: 13,
    },
  ];
  ...
  const mainCourses = [
    {
      ...
      description: "Pan-seared salmon fillet topped with an herb crust, served with garlic mashed potatoes and seasonal vegetables.",
      price: 25,
    },
    {
      name: "Filet Mignon",
      description: "Tender filet mignon cooked to perfection, served with red wine reduction, roasted asparagus, and truffle fries.",
      price: 36,
    },
    {
      name: "Wild Mushroom Risotto",
      description: "Creamy Arborio rice cooked with wild mushrooms, finished with parmesan and fresh herbs.",
      price: 20,
    },
    {
      name: "Chicken Piccata",
      description: "Sautéed chicken breast in a lemon-caper sauce, served with linguine and steamed broccoli.",
      price: 22,
    },
  ];
  ...
  const desserts = [
    {
      ...
      description: "A warm chocolate cake with a gooey center, served with vanilla ice cream and fresh berries.",
      price: 10,
    },
    {
    ...
    {
      name: "Lemon Sorbet",
      description: "A refreshing lemon sorbet served in a lemon shell, perfect for cleansing the palate.",
      price: 7,
    },
    {
      name: "Pistachio Baklava",
      description: "Layers of flaky pastry filled with pistachios and honey, served with a side of whipped cream.",
      price: 8,
    },
  ];
  ...
  appetizers.forEach(appetizer => {
    ...
    appetizersDiv.append(name, description, price);
  })
  ...
  salads.forEach(salad => {
    ...
    saladsDiv.append(name, description, price);
  })
  ...
  mainCourses.forEach(mainCourse => {
    ...
    mainCoursesDiv.append(name, description, price);
  })
  ...
  desserts.forEach(dessert => {
    ...
    dessertsDiv.append(name, description, price);
  })
  ...
  beverages.forEach(beverage => {
    ...
    beveragesDiv.append(name, price);
  })
  ...
  menuDiv.append(menuHeading, menuContent);
